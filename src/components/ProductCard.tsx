...
const ProductCard = ({ product, onAdd }: ProductCardProps) => {
	...
	return (
		<>
			...
			<Card className="group relative overflow-hidden mx-2 my-2 sm:mx-0 sm:my-0 bg-white/70 backdrop-blur-sm border border-white/20 hover:bg-white/80 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
				<CardContent className="p-0">
					...
					<div className="p-4 sm:p-6 bg-gradient-to-b from-white/50 to-white/30 backdrop-blur-sm">
						<div className="space-y-3 sm:space-y-4">
							{/* Title */}
							<h3 className="font-semibold text-sm sm:text-lg text-gray-900 mb-1 group-hover:text-blue-600 transition-colors duration-300 line-clamp-2 leading-tight">
								{product.name}
							</h3>
							...
							<div className="flex items-center justify-between gap-3">
								...
								<div className="flex flex-col justify-center min-w-0 flex-1">
									<span className="text-base sm:text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-none">
										${product.price}
									</span>
								...
								<button
									...
									className={`w-full sm:w-auto px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm transition-colors duration-500 flex items-center justify-center gap-1.5 sm:gap-2 ${
										!product.inStock
